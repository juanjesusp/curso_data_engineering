...
SELECT
    ...
    GROUP BY A.PROMO_ID, A.discount, B.SHIPPING_COST, B.SHIPPING_SERVICE, B.USER_ID, B.ORDER_COST, B.SHIPPING_COST, A.DISCOUNT, B.ORDER_TOTAL, B.CREATED_AT, B.DELIVERED_AT
